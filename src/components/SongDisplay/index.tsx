...
export type ISongDisplayStatus = {
	isPlay: boolean;
};
...
const initialSongDisplayStatus: Required<ISongDisplayStatus> = {
	isPlay: false,
};
...
const SongDisplay = (props: SongDisplayPropsType) => {
	...
	const [isPlay, setPlay] = useState<boolean>(
		initialSongDisplayStatus.isPlay
	);
...
export default React.memo(SongDisplay);
