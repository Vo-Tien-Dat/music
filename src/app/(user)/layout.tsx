'use client';
import ContentControl from '@/components/ContentContol';
        ...
        >
            <div className="col-span-3 " style={siderStyle}>
                <div className="flex flex-col gap-2 w-full h-full">
                    <Sider />
                    <div className="bg-neutral-900 h-3 rounded-lg grow">
                        <ContentControl />
                    </div>
                </div>
            </div>
            ...
            <div className="bg-neutral-900 rounded-lg" style={songDisplayStyle}>
                <SongDisplay />
            </div>
        </div>
    );
